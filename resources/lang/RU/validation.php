...
return [
    ...
    'payment_type_numeric' => 'Поле "Тип оплаты" должно быть числовым.',
    'image_image' => 'Загруженный файл должен быть изображением.',
    'image_mimes' => 'Файл изображения должен быть в формате :values.',
    'image_max' => 'Размер файла изображения не должен превышать :max килобайт.',
    


    'position_max' => 'Заголовок должен содержать не более 1000 символов!',
    'deadline_date' => 'Конечная дата должна быть в правильном формате!',
    'min_age_numeric' => 'Минимальный возраст должен быть числовым!',
    'max_age_numeric' => 'Максимальный возраст должен быть числовым!',
    'contact_email_email' => 'Введите контактный email в правильном формате.',
    'contact_link_active_url' => 'Контактная информация должна быть в правильном URL-формате.',




    'about_min' => 'Поле "about" должно содержать минимум 20 символов.',
    'address_max' => 'Поле "address" должно содержать максимум 255 символов.',
    'website_max' => 'Поле "website" должно содержать максимум 255 символов.',
    'instagram_max' => 'Поле "instagram" должно содержать максимум 255 символов.',
    'facebook_max' => 'Поле "facebook" должно содержать максимум 255 символов.',
    'linkedin_max' => 'Поле "linkedin" должно содержать максимум 255 символов.',
    'twitter_max' => 'Поле "twitter" должно содержать максимум 255 символов.',
    'image_max' => 'Файл изображения должен иметь размер не более 5120 килобайт.',




    'position_max' => 'Поле "Должность" должно содержать не более :max символов.',
    'image_max' => 'Файл изображения должен быть не более :max килобайт.',
    'cv_mimes' => 'Файл резюме должен быть в формате :values.',
    'cv_max' => 'Файл резюме должен быть не более :max килобайт.',

    'phone_numeric' => 'Должно быть введено телефонное число!',
    ...
    'attributes' => [
        ...
        'phone' => 'Телефон',
        'subscriberCode' => 'Код подписчика',
        'surveyType' => 'Тип заявления',
        'subject' => 'Предмет',
        ...
        'question' => 'Вопрос',
        'incident_adress' => 'Адрес инцидента',
