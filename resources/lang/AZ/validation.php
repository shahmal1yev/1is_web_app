...
'payment_type_numeric' => 'Ödəniş növü sahəsi rəqəmsal olmalıdır.',
'image_max' => 'Şəkil faylı maksimum :max kilobayt olmalıdır.',





'position_max' => 'Başlıq maksimum 1000 hərf olmalıdır!',
...
'about_min' => 'Haqqında sahəsi ən az 20 simvol olmalıdır.',
'address_max' => 'Ünvan sahəsi ən çox 255 simvol olmalıdır.',
'website_max' => 'Web sayt sahəsi ən çox 255 simvol olmalıdır.',
'instagram_max' => 'Instagram sahəsi ən çox 255 simvol olmalıdır.',
'facebook_max' => 'Facebook sahəsi ən çox 255 simvol olmalıdır.',
'linkedin_max' => 'LinkedIn sahəsi ən çox 255 simvol olmalıdır.',
'twitter_max' => 'Twitter sahəsi ən çox 255 simvol olmalıdır.',
'image_max' => 'Şəkil faylı ən çox 5120 kilobayt olmalıdır.',


'position_max' => 'Vəzifə başlığı maksimum :max simvol olmalıdır.',
'image_max' => 'Şəkil faylı maksimum :max kilobayt olmalıdır.',
'cv_mimes' => 'CV faylı yalnız :values formatında ola bilər.',
'cv_max' => 'CV faylı maksimum :max kilobayt olmalıdır.',
'phone_numeric' => 'Telefon rəqəm olmalıdır!',
    ...
    */
    ...
    'attributes' => [
        ...
        'desc_en' => 'Açıqlama ( en )',
        'desc_ru' => 'Açıqlama ( ru )',
        'images' => 'Şəkil və ya şəkillər',
        'question_az' => 'Sual ( az )',
        'question_en' => 'Sual ( en )',
        'question_ru' => 'Sual ( ru )',
        'response_az' => 'Cavab ( az )',
        'response_en' => 'Cavab ( en )',
        'response_ru' => 'Cavab ( ru )',
        'type' => 'Menyu növü',
        'main_menu' => 'Ana menyu',
        ...
        'phone' => 'Telefon',
        'subscriberCode' => 'Abonent Kodu',
        'surveyType' => 'Müraciətin növü',
        'subject' => 'Mövzu',
        'desc' => 'Qısa təsvir',
        //hotline
        'name' => 'Ad',
        ...
        'question' => 'Sual',
        'incident_adress' => 'Hadisə yeri adresi',
