...
@section('title','1is | Məxfilik Siyasəti | Proqram təminatı')
@section('content')
    <!-- start page title -->
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Məxfilik Siyasəti | Proqram təminatı</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('adminIndex')}}">Ana səhifə</a></li>
                        <li class="breadcrumb-item active">Məxfilik Siyasəti | Proqram təminatı</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 d-flex justify-content-end mb-4">
                        <button class="btn btn-success" onclick="addPolicy()">Məxfilik Siyasəti | Proqram təminatı əlavə et</button>
                    </div>
    ...
    <div class="modal fade" id="getPolicy" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="{{route('privacyProEditPost')}}" method="POST" class="modal-dialog">
            @csrf
            <div class="modal-content">
                <input type="hidden" id="edit_id" name="id">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Məxfilik Siyasəti | Proqram təminatı redaktə<span id="get_name"></span></h5>
    ...
    <div class="modal fade" id="addPolicy" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <form action="{{route('privacyProAddPost')}}" method="POST" class="modal-dialog">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Məxfilik Siyasəti | Proqram təminatı əlavə<span id="get_name"></span></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
...
@section('js')
    ...
    <script>
        ...
        const getPolicy = (id) => {
            ...
            $.ajax({
                type: "POST",
                url: "/admin/privacy/software/edit",
                data: {
                    _token: CSRF_TOKEN,
                    id,
                },
        ...
        const changeStatus = (id) => {
            ...
            $.ajax({
                type: "POST",
                url: "/admin/privacy/software/status",
                data: {
                    _token: CSRF_TOKEN,
                    id,
                },
        ...
        const deletePolicy = (id) => {
            ...
            Swal.fire({
                ...
                if(t.value){
                    $.ajax({
                        type: "POST",
                        url: "/admin/privacy/software/delete",
                        data: {
                            _token: CSRF_TOKEN,
                            id,
