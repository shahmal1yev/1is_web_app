...
@section('title','1is | Təlimlər | Təlim redaktə et')
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Təlim redaktə et</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{route('adminIndex')}}">Əsas Səhifə</a></li>
                        <li class="breadcrumb-item active">Təlim redaktə et</li>
                    </ol>
                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Təlim redaktə et</h4>
                    <div class="col-lg-12 text-center">
                        <p>Cari şəkil: </p>
                        <img src="{{asset($training->image)}}" alt="" width="200" height="200">
                    </div>
                    @include('back.layouts.messages')
                    <form action="{{route('trainingeditPost')}}" method="POST" id="addTraining" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12">
                                ...
                                <input class="form-control" type="text" id="title" name="title" placeholder="Təlim adı daxil edin:" value="{{$training->title}}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-12">
                                <label for="about" class="form-label">Təlim haqqında <span class="text-danger">*</span></label>
                                <textarea name="about" id="about" cols="30" rows="5" class="form-control editor" placeholder="Təlim haqqında məlumat daxil edin:">{!! $training->about !!}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-12">
                                <label for="address" class="form-label">Yönləndirilmə linki <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" id="link" name="link" placeholder="Yönləndirilmə linki daxil edin:" value="{{$training->redirect_link}}">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-lg-12">
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-12">
                                ...
                                <input class="form-control" type="date"  name="deadline" placeholder="Son müraciət tarixi daxil edin:" value="{{$training->deadline}}">
                            </div>
                        </div>
