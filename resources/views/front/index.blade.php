...
@section('content')
    ...
    <!-- COMPANY SECTION -->
        <section class="company">
                ...
                <a href="{{route('compdetail', $company->id)}}">
                    <div class="comp-card">
                        ...
                        <div class="company-content">
                            <div class="inner1">
                                <p>
                                    @if (mb_strlen($company->name) > 45)
                                        {{ html_entity_decode(mb_substr($company->name, 0, 45)) . '...' }}
                                    @else
            ...
            <button class="pop-button"><a href="{{route('allcompany')}}"  style="color: #ffff;">@lang('front.dahacox')</a></button>
        </section>
    ...
    <!-- NEW VACANSIES SECTION -->
        <section class="new-vac">
                ...
                <div class="vac-card">
                    ...
                    <div class="vac-inner2">
                        <a href="{{route('vacancydetail', $vacancy->id)}}" class="vac-name">
                            @if(mb_strlen($vacancy->position) > 60)
                            {{ html_entity_decode(mb_substr($vacancy->position, 0, 60)) . '...' }}
                        @else
            ...
            <button class="pop-button2 load_more_button" id ="$last_id"><a href="{{route('allvacancies')}}"  style="color: #ffff;">@lang('front.allvac')</a></button>
        </section>
